...
optionsa.handle = fig;
optionsa.color_area = [179, 0, 0]./255;   
...
optionsb.handle = fig;
optionsb.color_area = [255, 0, 0]./255;   
...
optionsc.handle = fig;
optionsc.color_area = [255, 51, 153]./255;  
...
optionsd.handle = fig;
optionsd.color_area = [204, 0, 255]./255;   
...
optionse.handle = fig;
optionse.color_area = [102, 0, 255]./255;   
...
optionsf.handle = fig;
optionsf.color_area = [0, 0, 153]./255;   
