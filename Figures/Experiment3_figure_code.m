...
for i = 1:RUNS
    [~, x_err_tsgd(i,:), A, A_tilde, y] = ltuple_COMP(n, x_star, maxiter, p1, ell, alpha);
    [~, x_err_msgd(i,:)] = mSGD_COMP(n, x_star, maxiter, p1, ell, alpha);
end

for j = 1:RUNS
    [~, x_err_sgd(j,:)] = SGD_COMP2(A_tilde, x_star, y, maxiter, alpha);
end
...
for j = 1:RUNS
    [~, x_err_sgd2(j,:)] = SGD_COMP2(A_tilde2, x_star, y, maxiter, alpha);
end
