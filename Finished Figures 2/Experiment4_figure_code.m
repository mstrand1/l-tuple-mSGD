...
for i = 1:RUNS
    [~, x_err1(i,:)] = tuple_mb(n, x, maxiter, p, ell, batch(1), alpha);
    [~, x_err2(i,:)] = tuple_mb(n, x, maxiter, p, ell, batch(2), alpha);
    [~, x_err3(i,:)] = tuple_mb(n, x, maxiter, p, ell, batch(3), alpha);
    [~, x_err4(i,:)] = tuple_mb(n, x, maxiter, p, ell, batch(4), alpha);
end
