function [xhat, approx_err] = tuple_mb(n, x_star, maxiter, p, ell, batch, alpha)
...
while iter < maxiter
    ...
    % Call g function 
    gxk = (1/p^2)*(A_tilde_batch'*(A_tilde_batch*xhat-p*y_batch))-((1-p)/p^2)*(L_matrix.*(A_tilde_batch'*A_tilde_batch))*xhat;
