function [xhat, x_err, A, A_tilde_zeros, A_tilde_del, A_tilde_col, A_tilde_knn, A_tilde_tsr, y, y_del, y_knn] = ltuple_MEGA_COMP(n, x, maxiter, p, ell, alpha)
...
while iter <= maxiter
    ...
    gxk = (1/p^2)*(Ai_tilde_zeros.'*(Ai_tilde_zeros *xhat-p*y(iter))) - ((1-p)/p^2)*(L_matrix .*(Ai_tilde_zeros.'*Ai_tilde_zeros))*xhat;
    x_t1 = xhat - alpha*gxk;
    xhat = x_t1;
